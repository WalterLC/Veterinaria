...
namespace Veterinaria.Controllers
{
    public class MascotaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Edad,Dueño")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Edad,Dueño")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
