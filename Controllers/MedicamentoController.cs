...
namespace Veterinaria.Controllers
{
    public class MedicamentoController : Controller
    {
        ...
        public MedicamentoController(VeterinariaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Administracion,Dosis")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Administracion,Dosis")] Medicamento medicamento)
        {
